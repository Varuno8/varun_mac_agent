...
extension Notification.Name {
    static let mickyDismissPanel = Notification.Name("mickyDismissPanel")
}
...
final class MenuBarPanelManager: NSObject {
    ...
    /// Draws the micky triangle as a menu bar icon. Uses the same shape
